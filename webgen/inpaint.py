...
systems = [
    ("E1 TTS (DMD)", "e1tts"),
    ("ARDiT (B=1, DMD)", "ardit_dmd_b1"),
    ("Mel Reconstruct", "mel_reconstruct"),
]
        ...
        with tbody():
            ...
            for sys_name, sys_id in systems:
                with tr():
                    ...
                    for _, _, _, key, _ in samples:
                        td(
                            audio(
                                source(
                                    src=f"{root}/{sys_id}/{key}.wav", type="audio/wav"
                                ),
                                controls="",
